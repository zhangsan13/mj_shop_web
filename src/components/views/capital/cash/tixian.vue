    ...
    <div class="cashout_main">
      ...
      <div class="cash_card">
        ...
        <div class="monet_input">
          <el-button type="primary" @click="tixianSubmit">确认提现</el-button>
    ...
    methods: {
      ...
      tipTextChange: async function() {
        ...
        if (val < 100) {
          ...
          //提现手续费
          let commission = await this.tixianFee();
          this.tip_text = `本次提现手续费${commission}元，到账金额${val - commission}元`;
