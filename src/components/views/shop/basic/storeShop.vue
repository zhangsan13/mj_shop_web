        ...
        <div class="form_wrap">
          ...
          <div class="form_box">
            <el-form-item label="网店名称：" >
              <p class="info_p">{{ruleForm.shop_name}}</p>
            </el-form-item>
            <el-form-item label="网店联系电话：" >
              <p class="info_p">{{ruleForm.shop_phone}} / {{ruleForm.shop_telephone}}</p>
            </el-form-item>
            <el-form-item label="网店logo：" >
    ...
    created:async function(){
      ...
      GetShopInfo.call(this,`?input.sessionId=${this.sessionId}&input.clientTimespan=${this.time}`).then(res=>{
        if (res.data.code === 1) {
          ...
          console.log(data)
          this.ruleForm.shop_name = data.name
          this.ruleForm.shop_phone = data.mobile
          this.ruleForm.shop_telephone = data.telephone
          ...
          if(data.otherPics !== null && data.otherPics !=="" &&data.otherPics.length != 0){
               for (var i = 0;i<data.otherPics.length;i++) {
