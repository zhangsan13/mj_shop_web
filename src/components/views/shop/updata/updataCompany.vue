<template>
  ...
  <div class="container">
    ...
    <div class="remind"><i class="el-icon-warning"></i>未通过原因：上传的营业执照模糊</div>
    <div class="main">
          ...
          <div class="form_wrap">
            ...
            <div class="form_box">
              ...
              <el-form-item  prop="particular" >
                <div>
                  <el-input type="textarea" style="width: 440px;" :autosize="{ minRows: 4}" resize="none" placeholder="请输入内容" v-model="ruleForm.particular"></el-input>
              ...
              <el-form-item label="营业执照号：">
                <el-input style="width: 440px;" placeholder="请输入营业执照号" v-model="ruleForm.license_code"></el-input>
                <!--<span class="license-one">营业执照号有变更？</span><span class="license-two">去重新入驻</span>-->
              </el-form-item>
              ...
              <el-form-item label="有效期：">
                ...
                <el-date-picker style="width: 211px;" v-model="ruleForm.endDate" type="date" placeholder="选择日期"></el-date-picker>
  ...
  export default {
    ...
    data () {
      return {
        ...
        options: [{ // 公司类型参数
           value: '选项1',label: '个体户'},
          {value: '选项2', label: '私营企业'},
          {value: '选项3', label: '国营企业'},
          {value: '选项4', label: '合资企业'},
          {value: '选项5', label: '上市公司'},
          {value: '选项6', label: '政府机构'},
          {value: '选项7', label: '事业单位'},
          {value: '选项8', label: '公益机构'}],
