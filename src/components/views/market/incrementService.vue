  ...
  <div class="incrementService_box">
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editSmsNode();msgNodeVisible = false">确 定</el-button>
      </span>
    </el-dialog>
    <!--短信发送节点弹框 end-->
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="renewVisible = false">确 定</el-button>
      </span>
    </el-dialog>
    <!--续费弹框 end-->
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="buyNowVisible = false">确 定</el-button>
      </span>
    </el-dialog>
    <!--立即购买弹框 end-->
