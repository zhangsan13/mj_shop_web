  ...
  <div class="addDiscount_box">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
      ...
      <el-form-item label="活动范围" label-width="100px" v-if="pageType !== 'detail'">
        <div>
          <el-button type="primary" @click="shopDataVisible = true">+ 添加主商品</el-button>
        </div>
      </el-form-item>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div class="gift_box">
                  <ul>
                    <li v-for="item in scope.row.giftList">
                      <div class="left">
                  ...
                  <div class="textLeft">
                    <el-button type="default" size="small">+ 添加赠品</el-button>
                  </div>
                </div>
              </template>
            </el-table-column>
      ...
      return {
        ...
        tableData: [{ // 表格数据
          ...
          giftList: [{
            ...
            title: 'Apple MacBook Air 13.3英寸笔记本电脑 银色(Core i5 处理器/8GB内存 /128GB SSD闪存3英寸笔记本电脑3英寸笔记本电脑3英寸笔记本电脑'
          }, {
            src: 'https://picsum.photos/id/237/200/300',
            title: 'Apple MacBook Air 13.3英寸笔记本电脑 银色(Core i5 处理器/8GB内存 /128GB SSD闪存'
          }, {
            src: 'https://picsum.photos/id/237/200/300',
            title: 'Apple MacBook Air 13.3英寸笔记本电脑 银色(Core i5 处理器/8GB内存 /128GB SSD闪存'
          }],
