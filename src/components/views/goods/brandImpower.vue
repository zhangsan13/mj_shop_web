  ...
  <div class="container">
    ...
    <div class="main">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
        ...
        <!--   该功能暂未实现
         <el-form-item label="商标注册证/品牌授权书：（该功能暂未实现，等前端来实现）" prop="brandImg" class="brand-img">
            <el-upload
    ...
    data() {
      return {
        ruleForm: {
          ...
          brand: '',
          date: '',
          brandImg: 'http://file.manjiwang.com/?d17f5e35eec3e026c061d0972adb4efd', //临时写一个默认图片
        },
        rules: {
          brand: [{required: true, message: '请选择品牌', trigger: 'change'}],
          date: [{required: true, message: '请选择授权时间', trigger: 'change'}],
          brandImg: [{required: true, message: '请上传商标注册证/品牌授权书', trigger: 'change'}],
        },
        pickerOptions: {
          disabledDate(time) {
